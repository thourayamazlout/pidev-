...
class srcApp_KernelDevDebugContainer extends Container
{
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('OhL3SyHSEM', 0, ($this->targetDir.''.'/pools'), new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL));
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('Y5KcKY6XNi', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('xiG7FkdN1P', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.property_info'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('cstpYcNhgG', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.security_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('Bi15B2sD-D', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('EJYDlfccMb', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('05V6bbtec8', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
...
class EntityManager_9a5be93 extends \Doctrine\ORM\EntityManager implements \ProxyManager\Proxy\VirtualProxyInterface
{
     ...
     */
    private $valueHolder5257b = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializerf3e8d = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties312a5 = [
        
    ];

    public function getConnection()
    {
        $this->initializerf3e8d && ($this->initializerf3e8d->__invoke($valueHolder5257b, $this, 'getConnection', array(), $this->initializerf3e8d) || 1) && $this->valueHolder5257b = $valueHolder5257b;

        return $this->valueHolder5257b->getConnection();
    }

    public function getMetadataFactory()
    {
        $this->initializerf3e8d && ($this->initializerf3e8d->__invoke($valueHolder5257b, $this, 'getMetadataFactory', array(), $this->initializerf3e8d) || 1) && $this->valueHolder5257b = $valueHolder5257b;

        return $this->valueHolder5257b->getMetadataFactory();
    }

    public function getExpressionBuilder()
    {
        $this->initializerf3e8d && ($this->initializerf3e8d->__invoke($valueHolder5257b, $this, 'getExpressionBuilder', array(), $this->initializerf3e8d) || 1) && $this->valueHolder5257b = $valueHolder5257b;

        return $this->valueHolder5257b->getExpressionBuilder();
    }

    public function beginTransaction()
    {
        $this->initializerf3e8d && ($this->initializerf3e8d->__invoke($valueHolder5257b, $this, 'beginTransaction', array(), $this->initializerf3e8d) || 1) && $this->valueHolder5257b = $valueHolder5257b;

        return $this->valueHolder5257b->beginTransaction();
    }

    public function getCache()
    {
        $this->initializerf3e8d && ($this->initializerf3e8d->__invoke($valueHolder5257b, $this, 'getCache', array(), $this->initializerf3e8d) || 1) && $this->valueHolder5257b = $valueHolder5257b;

        return $this->valueHolder5257b->getCache();
    }

    public function transactional($func)
    {
        $this->initializerf3e8d && ($this->initializerf3e8d->__invoke($valueHolder5257b, $this, 'transactional', array('func' => $func), $this->initializerf3e8d) || 1) && $this->valueHolder5257b = $valueHolder5257b;

        return $this->valueHolder5257b->transactional($func);
    }

    public function commit()
    {
        $this->initializerf3e8d && ($this->initializerf3e8d->__invoke($valueHolder5257b, $this, 'commit', array(), $this->initializerf3e8d) || 1) && $this->valueHolder5257b = $valueHolder5257b;

        return $this->valueHolder5257b->commit();
    }

    public function rollback()
    {
        $this->initializerf3e8d && ($this->initializerf3e8d->__invoke($valueHolder5257b, $this, 'rollback', array(), $this->initializerf3e8d) || 1) && $this->valueHolder5257b = $valueHolder5257b;

        return $this->valueHolder5257b->rollback();
    }

    public function getClassMetadata($className)
    {
        $this->initializerf3e8d && ($this->initializerf3e8d->__invoke($valueHolder5257b, $this, 'getClassMetadata', array('className' => $className), $this->initializerf3e8d) || 1) && $this->valueHolder5257b = $valueHolder5257b;

        return $this->valueHolder5257b->getClassMetadata($className);
    }

    public function createQuery($dql = '')
    {
        $this->initializerf3e8d && ($this->initializerf3e8d->__invoke($valueHolder5257b, $this, 'createQuery', array('dql' => $dql), $this->initializerf3e8d) || 1) && $this->valueHolder5257b = $valueHolder5257b;

        return $this->valueHolder5257b->createQuery($dql);
    }

    public function createNamedQuery($name)
    {
        $this->initializerf3e8d && ($this->initializerf3e8d->__invoke($valueHolder5257b, $this, 'createNamedQuery', array('name' => $name), $this->initializerf3e8d) || 1) && $this->valueHolder5257b = $valueHolder5257b;

        return $this->valueHolder5257b->createNamedQuery($name);
    }

    public function createNativeQuery($sql, \Doctrine\ORM\Query\ResultSetMapping $rsm)
    {
        $this->initializerf3e8d && ($this->initializerf3e8d->__invoke($valueHolder5257b, $this, 'createNativeQuery', array('sql' => $sql, 'rsm' => $rsm), $this->initializerf3e8d) || 1) && $this->valueHolder5257b = $valueHolder5257b;

        return $this->valueHolder5257b->createNativeQuery($sql, $rsm);
    }

    public function createNamedNativeQuery($name)
    {
        $this->initializerf3e8d && ($this->initializerf3e8d->__invoke($valueHolder5257b, $this, 'createNamedNativeQuery', array('name' => $name), $this->initializerf3e8d) || 1) && $this->valueHolder5257b = $valueHolder5257b;

        return $this->valueHolder5257b->createNamedNativeQuery($name);
    }

    public function createQueryBuilder()
    {
        $this->initializerf3e8d && ($this->initializerf3e8d->__invoke($valueHolder5257b, $this, 'createQueryBuilder', array(), $this->initializerf3e8d) || 1) && $this->valueHolder5257b = $valueHolder5257b;

        return $this->valueHolder5257b->createQueryBuilder();
    }

    public function flush($entity = null)
    {
        $this->initializerf3e8d && ($this->initializerf3e8d->__invoke($valueHolder5257b, $this, 'flush', array('entity' => $entity), $this->initializerf3e8d) || 1) && $this->valueHolder5257b = $valueHolder5257b;

        return $this->valueHolder5257b->flush($entity);
    }

    public function find($className, $id, $lockMode = null, $lockVersion = null)
    {
        $this->initializerf3e8d && ($this->initializerf3e8d->__invoke($valueHolder5257b, $this, 'find', array('className' => $className, 'id' => $id, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializerf3e8d) || 1) && $this->valueHolder5257b = $valueHolder5257b;

        return $this->valueHolder5257b->find($className, $id, $lockMode, $lockVersion);
    }

    public function getReference($entityName, $id)
    {
        $this->initializerf3e8d && ($this->initializerf3e8d->__invoke($valueHolder5257b, $this, 'getReference', array('entityName' => $entityName, 'id' => $id), $this->initializerf3e8d) || 1) && $this->valueHolder5257b = $valueHolder5257b;

        return $this->valueHolder5257b->getReference($entityName, $id);
    }

    public function getPartialReference($entityName, $identifier)
    {
        $this->initializerf3e8d && ($this->initializerf3e8d->__invoke($valueHolder5257b, $this, 'getPartialReference', array('entityName' => $entityName, 'identifier' => $identifier), $this->initializerf3e8d) || 1) && $this->valueHolder5257b = $valueHolder5257b;

        return $this->valueHolder5257b->getPartialReference($entityName, $identifier);
    }

    public function clear($entityName = null)
    {
        $this->initializerf3e8d && ($this->initializerf3e8d->__invoke($valueHolder5257b, $this, 'clear', array('entityName' => $entityName), $this->initializerf3e8d) || 1) && $this->valueHolder5257b = $valueHolder5257b;

        return $this->valueHolder5257b->clear($entityName);
    }

    public function close()
    {
        $this->initializerf3e8d && ($this->initializerf3e8d->__invoke($valueHolder5257b, $this, 'close', array(), $this->initializerf3e8d) || 1) && $this->valueHolder5257b = $valueHolder5257b;

        return $this->valueHolder5257b->close();
    }

    public function persist($entity)
    {
        $this->initializerf3e8d && ($this->initializerf3e8d->__invoke($valueHolder5257b, $this, 'persist', array('entity' => $entity), $this->initializerf3e8d) || 1) && $this->valueHolder5257b = $valueHolder5257b;

        return $this->valueHolder5257b->persist($entity);
    }

    public function remove($entity)
    {
        $this->initializerf3e8d && ($this->initializerf3e8d->__invoke($valueHolder5257b, $this, 'remove', array('entity' => $entity), $this->initializerf3e8d) || 1) && $this->valueHolder5257b = $valueHolder5257b;

        return $this->valueHolder5257b->remove($entity);
    }

    public function refresh($entity)
    {
        $this->initializerf3e8d && ($this->initializerf3e8d->__invoke($valueHolder5257b, $this, 'refresh', array('entity' => $entity), $this->initializerf3e8d) || 1) && $this->valueHolder5257b = $valueHolder5257b;

        return $this->valueHolder5257b->refresh($entity);
    }

    public function detach($entity)
    {
        $this->initializerf3e8d && ($this->initializerf3e8d->__invoke($valueHolder5257b, $this, 'detach', array('entity' => $entity), $this->initializerf3e8d) || 1) && $this->valueHolder5257b = $valueHolder5257b;

        return $this->valueHolder5257b->detach($entity);
    }

    public function merge($entity)
    {
        $this->initializerf3e8d && ($this->initializerf3e8d->__invoke($valueHolder5257b, $this, 'merge', array('entity' => $entity), $this->initializerf3e8d) || 1) && $this->valueHolder5257b = $valueHolder5257b;

        return $this->valueHolder5257b->merge($entity);
    }

    public function copy($entity, $deep = false)
    {
        $this->initializerf3e8d && ($this->initializerf3e8d->__invoke($valueHolder5257b, $this, 'copy', array('entity' => $entity, 'deep' => $deep), $this->initializerf3e8d) || 1) && $this->valueHolder5257b = $valueHolder5257b;

        return $this->valueHolder5257b->copy($entity, $deep);
    }

    public function lock($entity, $lockMode, $lockVersion = null)
    {
        $this->initializerf3e8d && ($this->initializerf3e8d->__invoke($valueHolder5257b, $this, 'lock', array('entity' => $entity, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializerf3e8d) || 1) && $this->valueHolder5257b = $valueHolder5257b;

        return $this->valueHolder5257b->lock($entity, $lockMode, $lockVersion);
    }

    public function getRepository($entityName)
    {
        $this->initializerf3e8d && ($this->initializerf3e8d->__invoke($valueHolder5257b, $this, 'getRepository', array('entityName' => $entityName), $this->initializerf3e8d) || 1) && $this->valueHolder5257b = $valueHolder5257b;

        return $this->valueHolder5257b->getRepository($entityName);
    }

    public function contains($entity)
    {
        $this->initializerf3e8d && ($this->initializerf3e8d->__invoke($valueHolder5257b, $this, 'contains', array('entity' => $entity), $this->initializerf3e8d) || 1) && $this->valueHolder5257b = $valueHolder5257b;

        return $this->valueHolder5257b->contains($entity);
    }

    public function getEventManager()
    {
        $this->initializerf3e8d && ($this->initializerf3e8d->__invoke($valueHolder5257b, $this, 'getEventManager', array(), $this->initializerf3e8d) || 1) && $this->valueHolder5257b = $valueHolder5257b;

        return $this->valueHolder5257b->getEventManager();
    }

    public function getConfiguration()
    {
        $this->initializerf3e8d && ($this->initializerf3e8d->__invoke($valueHolder5257b, $this, 'getConfiguration', array(), $this->initializerf3e8d) || 1) && $this->valueHolder5257b = $valueHolder5257b;

        return $this->valueHolder5257b->getConfiguration();
    }

    public function isOpen()
    {
        $this->initializerf3e8d && ($this->initializerf3e8d->__invoke($valueHolder5257b, $this, 'isOpen', array(), $this->initializerf3e8d) || 1) && $this->valueHolder5257b = $valueHolder5257b;

        return $this->valueHolder5257b->isOpen();
    }

    public function getUnitOfWork()
    {
        $this->initializerf3e8d && ($this->initializerf3e8d->__invoke($valueHolder5257b, $this, 'getUnitOfWork', array(), $this->initializerf3e8d) || 1) && $this->valueHolder5257b = $valueHolder5257b;

        return $this->valueHolder5257b->getUnitOfWork();
    }

    public function getHydrator($hydrationMode)
    {
        $this->initializerf3e8d && ($this->initializerf3e8d->__invoke($valueHolder5257b, $this, 'getHydrator', array('hydrationMode' => $hydrationMode), $this->initializerf3e8d) || 1) && $this->valueHolder5257b = $valueHolder5257b;

        return $this->valueHolder5257b->getHydrator($hydrationMode);
    }

    public function newHydrator($hydrationMode)
    {
        $this->initializerf3e8d && ($this->initializerf3e8d->__invoke($valueHolder5257b, $this, 'newHydrator', array('hydrationMode' => $hydrationMode), $this->initializerf3e8d) || 1) && $this->valueHolder5257b = $valueHolder5257b;

        return $this->valueHolder5257b->newHydrator($hydrationMode);
    }

    public function getProxyFactory()
    {
        $this->initializerf3e8d && ($this->initializerf3e8d->__invoke($valueHolder5257b, $this, 'getProxyFactory', array(), $this->initializerf3e8d) || 1) && $this->valueHolder5257b = $valueHolder5257b;

        return $this->valueHolder5257b->getProxyFactory();
    }

    public function initializeObject($obj)
    {
        $this->initializerf3e8d && ($this->initializerf3e8d->__invoke($valueHolder5257b, $this, 'initializeObject', array('obj' => $obj), $this->initializerf3e8d) || 1) && $this->valueHolder5257b = $valueHolder5257b;

        return $this->valueHolder5257b->initializeObject($obj);
    }

    public function getFilters()
    {
        $this->initializerf3e8d && ($this->initializerf3e8d->__invoke($valueHolder5257b, $this, 'getFilters', array(), $this->initializerf3e8d) || 1) && $this->valueHolder5257b = $valueHolder5257b;

        return $this->valueHolder5257b->getFilters();
    }

    public function isFiltersStateClean()
    {
        $this->initializerf3e8d && ($this->initializerf3e8d->__invoke($valueHolder5257b, $this, 'isFiltersStateClean', array(), $this->initializerf3e8d) || 1) && $this->valueHolder5257b = $valueHolder5257b;

        return $this->valueHolder5257b->isFiltersStateClean();
    }

    public function hasFilters()
    {
        $this->initializerf3e8d && ($this->initializerf3e8d->__invoke($valueHolder5257b, $this, 'hasFilters', array(), $this->initializerf3e8d) || 1) && $this->valueHolder5257b = $valueHolder5257b;

        return $this->valueHolder5257b->hasFilters();
    }
    ...
    public static function staticProxyConstructor($initializer)
    {
        ...
        $instance->initializerf3e8d = $initializer;
    ...
    protected function __construct(\Doctrine\DBAL\Connection $conn, \Doctrine\ORM\Configuration $config, \Doctrine\Common\EventManager $eventManager)
    {
        ...
        if (! $this->valueHolder5257b) {
            $reflection = $reflection ?? new \ReflectionClass('Doctrine\\ORM\\EntityManager');
            $this->valueHolder5257b = $reflection->newInstanceWithoutConstructor();
        \Closure::bind(function (\Doctrine\ORM\EntityManager $instance) {
            unset($instance->config, $instance->conn, $instance->metadataFactory, $instance->unitOfWork, $instance->eventManager, $instance->proxyFactory, $instance->repositoryFactory, $instance->expressionBuilder, $instance->closed, $instance->filterCollection, $instance->cache);
        ...
        $this->valueHolder5257b->__construct($conn, $config, $eventManager);
    }

    public function & __get($name)
    {
        $this->initializerf3e8d && ($this->initializerf3e8d->__invoke($valueHolder5257b, $this, '__get', ['name' => $name], $this->initializerf3e8d) || 1) && $this->valueHolder5257b = $valueHolder5257b;

        if (isset(self::$publicProperties312a5[$name])) {
            return $this->valueHolder5257b->$name;
        }

        $realInstanceReflection = new \ReflectionClass('Doctrine\\ORM\\EntityManager');

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5257b;
    ...
    {
        $this->initializerf3e8d && ($this->initializerf3e8d->__invoke($valueHolder5257b, $this, '__set', array('name' => $name, 'value' => $value), $this->initializerf3e8d) || 1) && $this->valueHolder5257b = $valueHolder5257b;
    ...
    {
        $this->initializerf3e8d && ($this->initializerf3e8d->__invoke($valueHolder5257b, $this, '__isset', array('name' => $name), $this->initializerf3e8d) || 1) && $this->valueHolder5257b = $valueHolder5257b;
    ...
    {
        $this->initializerf3e8d && ($this->initializerf3e8d->__invoke($valueHolder5257b, $this, '__unset', array('name' => $name), $this->initializerf3e8d) || 1) && $this->valueHolder5257b = $valueHolder5257b;
    ...
    {
        $this->initializerf3e8d && ($this->initializerf3e8d->__invoke($valueHolder5257b, $this, '__clone', array(), $this->initializerf3e8d) || 1) && $this->valueHolder5257b = $valueHolder5257b;

        $this->valueHolder5257b = clone $this->valueHolder5257b;
    }

    public function __sleep()
    {
        $this->initializerf3e8d && ($this->initializerf3e8d->__invoke($valueHolder5257b, $this, '__sleep', array(), $this->initializerf3e8d) || 1) && $this->valueHolder5257b = $valueHolder5257b;

        return array('valueHolder5257b');
    }
    ...
    {
        $this->initializerf3e8d = $initializer;
    }

    public function getProxyInitializer() : ?\Closure
    {
        return $this->initializerf3e8d;
    }

    public function initializeProxy() : bool
    {
        return $this->initializerf3e8d && ($this->initializerf3e8d->__invoke($valueHolder5257b, $this, 'initializeProxy', array(), $this->initializerf3e8d) || 1) && $this->valueHolder5257b = $valueHolder5257b;
    }

    public function isProxyInitialized() : bool
    {
        return null !== $this->valueHolder5257b;
    }

    public function getWrappedValueHolderValue()
    {
        return $this->valueHolder5257b;
    }
}
